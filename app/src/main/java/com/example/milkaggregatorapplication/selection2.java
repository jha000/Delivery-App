...
public class selection2 extends AppCompatActivity implements PaymentResultListener {
    ...
    TextView a,b,c,d,p,q,r,s,product,add;
    EditText x,y;
    TextView m,n,o,k;
    ...
    Dialog myDialog,paymentDialog,FailureDialog;
...
//        s=(TextView)findViewById(R.id.dam4);
        ...
        x=(EditText) findViewById(R.id.edit1);
...
//
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            name.setText(intent.getStringExtra(EXTRA_COURSE_NAME));
            product.setText(intent.getStringExtra(EXTRA_DESCRIPTION));
